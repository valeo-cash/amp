...
import { PricingConfig, RoutePricing, ChannelState, MeteringProof } from "@valeo/amp-core";
...
export interface AMPServerEvents {
    ...
    "channel:settled": (channel: PublicKey, proof: MeteringProof, txSig: string) => void;
